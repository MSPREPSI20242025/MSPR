...
export default function DataPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setError(t('pages.allData.error', 'Unable to load data. Please check if the API server and database are running.'));
            } finally {
                setLoading(false);
            }
        };
    ...
    const handleCountryChange = async (country: string) => {
        ...
        try {
            ...
            setError(t('pages.allData.error', 'Unable to load country data. Please check if the API server and database are running.'));
        }
    };
